package atividade.gen.blogPessoal.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("atividade.gen.blogPessoal.controller"))
	...
	private static Contact contact() {
		return new Contact("Mabia", "https://github.com/maefazcafe", "gabrielapaganini67@gmail.com");
	}
